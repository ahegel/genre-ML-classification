...
The code for this project is [here](https://github.com/ahegel/genre-ML-classification/blob/master/genre_classification.py).

Here is a visual overview of the methods:

![Classification workflow diagram](/images/classification_workflow.png)
